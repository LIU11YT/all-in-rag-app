...
class RetrievalOptimizationModule:
    ...
    def retrieve_with_debug(self, query: str, filters: Dict[str, Any] | None = None, top_k: int = 5):
        if filters:
            docs = self.metadata_filtered_search(query, filters, top_k=top_k)
        else:
